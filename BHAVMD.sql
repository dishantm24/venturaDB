...
convert(float ,sp.[SPANMgn] ) / 100 as [SPANMgn] ,
convert(float ,sp.[ExpMgn] ) /100 as [ExpMgn],
convert(float ,sp.[AddExpMgn] ) / 100 as [AddExpMgn],
--sp.[ExpMgn],
--sp.[AddExpMgn]  ,
f.FNOMAR * 100 as 'FNOMAR',--=(Y1+Z1+AA1)*100
...
group by t.scripcode,FNOIND,MAXIUMVALUE,t.CAT,c.Base,d.Base,e.Base
