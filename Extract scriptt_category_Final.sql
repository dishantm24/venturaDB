...
select   
FNOIND,CAT_1,ISINNO,scripcode,[Symbol Series],Series,CAT,BASE,[T-4V],[T-3V],[T-2V],[T-1V],[T]
...
--and FNOIND is NULL 
--and ISINNO = 'INE733E01010'
order by FNOIND desc 




select * from marginreport where ISINNO = 'INE148I07NM7'
select * from #temp1
